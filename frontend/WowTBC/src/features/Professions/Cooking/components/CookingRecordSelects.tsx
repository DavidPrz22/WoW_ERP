...
import { useFactionOptions, useRealmOptions, useUserDataRecordDetails, useRecordsSelect } from "@/hooks/useQueryHooks";
import { useEffect } from "react";

export function CookingRecordSelects() {
  const {
    dataFaction,
    dataRealm,
    dataRecordId,
  ...
  const initialDataRecordId = cookingGroupsData ? dataRecordId : "";
